...
######### START VALID TREE DELETE TEST #########
# this test deletes an existing tree
$testname = 'Valid tree delete: ';
$tx = $uaValid->delete($server . $port . '/tree/' . $singleTreeID);

ok(204 == $tx->res->code,               $testname . 'Response Code is 204');
######### END VALID TREE DELETE TEST #########

######### START VALID TREE DELETE TEST #########
# this test deletes an existing tree
$testname = 'Valid tree delete: ';
$tx = $uaValid->delete($server . $port . '/tree/' . $validTreeID);
